...
protected:
	...
	afx_msg void OnAnimationShaders();
	afx_msg void OnUpdateAnimationShaders(CCmdUI* pCmdUI);
	afx_msg void OnViewShaders();
	afx_msg void OnUpdateViewShaders(CCmdUI* pCmdUI);
	afx_msg void OnViewEntityColor();
	afx_msg void OnSequencesSearch();
	afx_msg void OnViewDynamicGlow();
	afx_msg void OnUpdateViewDynamicGlow(CCmdUI* pCmdUI);
	afx_msg void OnViewDynamicGlowSoft();
